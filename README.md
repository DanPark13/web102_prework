...
Sometimes, getting the images to correspond and work within the game cards was painful, but I managed to figure it out with good debugging and analyzing the `styles.css` page and its relationship with `index.html`. Oh CSS!
